...
window.onload = (event) =>{
	setTimeout(function() {
		snowFall.snow(document.getElementsByTagName('body')[0], {image : SNOW_Picture, minSize: 17, maxSize:42, flakeCount:30, maxSpeed: 5, minSpeed: 2});
	}, 100);
};
...
if(biicore.bgMusic){
	...
	<div class="bii-player">
		<div id="btnnhac" onclick="playPause();" class="bii-player-secondary"><div class="bii-player-secondary-content">Click vào đây để nghe nhạc nhé!</div></div>
		<div id="btnnhac1" onclick="playPause();" class="playerIcon">
